...
//                                    break;
                    ...
                    if(! socket.isClosed()) {
                            ...
                            if(Server.usersOnline.contains(nickname) || Server.usersBanned.contains(nickname)){
                                serverOutput.println("Sorry "+nickname+" has be online or is Banned, please try later...");
                                serverOutput.println("SERVER:\tGoodbye");
            						  closeConnections(userInput, serverOutput, socket);                    
										  //break;
                            }
